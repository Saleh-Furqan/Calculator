...
const calcBodyClass = "max-w-lg rounded overflow-hidden shadow-2xl flex";
...
function addClasses(button) {
  ...
  const baseClass =
    "flex w-12 h-12 justify-center items-center m-1 font-bold py-4 px-4 border hover:border-transparent rounded text-white border-2 text-2xl";
