...
/*const clearClass = 'bg-purple-800 bg-gradient-to-br from-blue-300 bg-opacity-25'
const clear = document.querySelector('.clear')
clearClass.split(' ').forEach(cls => clear.classList.add(cls))

const numberClass = 'flex w-12 h-12 justify-center items-center m-1 font-bold py-2 px-2 border hover:border-transparent rounded text-white border-2 text-2xl hover:bg-green-500 border-green-500'
const numbers = document.querySelectorAll('.number')
numberClass.split(' ').forEach(cls => numbers.classList.add(cls))*/
